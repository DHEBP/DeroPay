...
export function StoreHero() {
  return (
    <section className="relative overflow-hidden px-6 pb-8 pt-12 md:px-10 md:pb-12 md:pt-16">
      <div className="mx-auto grid w-full max-w-7xl gap-6 lg:gap-8 xl:grid-cols-[1.1fr_0.9fr]">
        <motion.div
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-3">
              <Link
              href="#collection"
              className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-[#071008] transition-[background-color,transform] hover:-translate-y-0.5 hover:bg-[var(--accent-strong)]"
            >
              Shop the collection
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-5 py-3 text-sm font-semibold text-white transition-colors hover:border-[var(--border-strong)] hover:bg-[var(--accent-dim)]"
            >
              See how it works
            </Link>
          </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {heroFacts.map((fact) => (
              <div
                key={fact}
                className="rounded-[1.4rem] border border-white/[0.08] bg-white/[0.04] p-5 text-sm leading-6 text-[var(--text-secondary)] text-pretty"
              >
                {fact}
              </div>
            ))}
        ...
        <motion.div
          ...
          className="flex"
        >
          <div className="glass-panel-strong soft-outline relative w-full overflow-hidden rounded-[2rem] p-5 md:p-6">
            ...
            <div className="relative mt-5 flex items-end justify-between gap-4">
              <div className="space-y-2">
                ...
                <p className="max-w-sm text-pretty text-sm leading-6 text-[var(--text-secondary)]">
